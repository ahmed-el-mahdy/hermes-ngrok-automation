...
Check `hermes-agent` logs, call its authenticated `/v1/models`, then test NaraRouter, the local bridge, and each recovery route. A provider HTTP 401 means invalid credentials; 402 means credit is required; 429 means quota or rate limiting.
