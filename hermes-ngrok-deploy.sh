...
install -m 0644 "$SOURCE_DIR/patch-open-webui-mobile.py" "$PROJECT_DIR/patch-open-webui-mobile.py"
...
HERMES_DASHBOARD_BASIC_AUTH_USERNAME=$OPEN_WEBUI_ADMIN_EMAIL
HERMES_DASHBOARD_BASIC_AUTH_PASSWORD=$OPEN_WEBUI_ADMIN_PASSWORD
HERMES_DASHBOARD_BASIC_AUTH_SECRET=$(random_secret 32)
